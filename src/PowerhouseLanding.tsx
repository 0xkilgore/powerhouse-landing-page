  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-zinc-100 antialiased selection:bg-emerald-300/20 selection:text-emerald-200">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10">
        ...
        <div className="absolute left-1/2 top-[-20%] h-[60vh] w-[80vw] -translate-x-1/2 rounded-full bg-[linear-gradient(90deg,rgba(80,140,255,0.25),rgba(168,85,247,0.25))] blur-3xl" />
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={item.title}
                className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]"
              >
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={b} className="rounded-xl border border-white/10 bg-white/5 p-4 text-zinc-300">
                {b}
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <a href="#achra" className="mt-5 inline-flex items-center gap-1 text-emerald-300 hover:text-emerald-200">
                Explore Achra →
              </a>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <ul className="mt-4 space-y-3 text-zinc-300">
                ...
                <li>
                  <strong className="text-zinc-100">Spec-driven AI control</strong>: agents act as governed contributors with
                  roles & permissions
                </li>
              ...
              <a href="#vetra" className="mt-5 inline-flex items-center gap-1 text-emerald-300 hover:text-emerald-200">
                Explore Vetra →
              </a>
            </div>
          </div>
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6">
              ...
              <p className="mt-4 text-zinc-300">
                Achra operates the marketplace—roadmaps, RFPs, delivery, payout rails. Vetra provides the reactive document
                architecture—packages, automations, and rulebooks that make the economics enforceable.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-3 text-zinc-300">
                Policies become structured data. Approvals trigger workflows and payouts; history is version-controlled and
                auditable.
              </p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-3 text-zinc-300">
                Define the rulebook; Powerhouse assembles the rest from a library of best-practice components—so governance,
                processes, and interfaces shape themselves to your requirements.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-3 text-zinc-300">
                We learned the hard lessons building in one of the longest-running DAOs and turned them into repeatable
                systems.
              </p>
              <p className="mt-3 text-zinc-300">
                <strong>Battle-tested patterns:</strong> Atlas rulebooks, operational hubs, marketplace workflows shaped by
                real-world delivery.
              </p>
              <p className="mt-3 text-zinc-300">
            ...
            <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-emerald-400/10 to-transparent p-6">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-emerald-400/30 bg-emerald-400/10 p-5">
                  ...
                  <a href="#pilot" className="mt-3 inline-flex items-center gap-1 text-emerald-300 hover:text-emerald-200">
                    Start a pilot →
                  </a>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                  ...
                  <a href="#builder" className="mt-3 inline-flex items-center gap-1 text-emerald-300 hover:text-emerald-200">
                    Request access →
                  </a>
                </div>
              </div>
