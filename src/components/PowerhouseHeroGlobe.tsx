...
type Props = {
  ...
  gridFrom?: string;
  gridTo?: string;
  energyStops?: [string, string, string];
};
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .ph-dash.fast   { ${animate ? `animation: ph-dash ${6}s linear infinite;` : ''} }
        .ph-dash.medium { ${animate ? `animation: ph-dash ${12}s linear infinite;` : ''} }
        .ph-dash.slow   { ${animate ? `animation: ph-dash ${18}s linear infinite;` : ''} }
